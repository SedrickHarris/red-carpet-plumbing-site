...
| Repiping | `Images/services/re-piping/re-piping-services.webp` | `public/images/services/re-piping/hero.webp` | Whole home repiping service in Las Vegas | Required |
...
- `repiping`: "Editorial close-up image of corroded or rusted..." for a problem-state visual
