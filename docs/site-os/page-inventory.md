...
| Repiping | `/re-piping/` | `app/plumbing-services/page.tsx:171`, `app/slab-leak-detection-repair/page.tsx:588, 634` | Planned | Referenced inline in Slab Leak Process Step 5 and Related Services |
...
4. **Repiping** (`/re-piping/`) — referenced from Plumbing Services Hub and Slab Leak (inline in Process Step 5). Closes the other Slab Leak forward-link gap.
