          ...
          <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24">
            ...
            <div className="mt-10 space-y-6">
              {ALIANTE_LEAK_CAUSES.map((cause) => (
                <article
                  key={cause.title}
                  className="relative bg-brand-surface-alt rounded-2xl p-6 pl-7 ring-1 ring-brand-surface-alt before:absolute before:bottom-6 before:left-0 before:top-6 before:w-1 before:rounded-full before:bg-brand-dark sm:p-8 sm:pl-9"
                >
