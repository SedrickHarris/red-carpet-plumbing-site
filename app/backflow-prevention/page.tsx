...
const SERVICE_AREA_LINKS: { name: string; href?: string }[] = [
  { name: "Las Vegas", href: "/las-vegas/backflow-prevention/" },
  { name: "Henderson" },
          ...
          <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24">
            ...
            <div className="mt-8 rounded-2xl border-l-4 border-brand-primary bg-brand-surface-alt p-6 sm:p-8">
              <p className="text-base leading-7 text-brand-dark sm:text-lg">
                ...
                prevention devices for homes and businesses throughout the
                Las Vegas Valley. Backflow preventers protect
              ...
              <SectionRevealItem>
                <div className="max-w-3xl text-left">
                  ...
                  <p className="mt-6 text-lg leading-8 text-brand-dark/80">
                    ...
                    for residential and commercial properties throughout the
                    Las Vegas Valley.
                  </p>
                </div>
              </SectionRevealItem>
        ...
        <section className="bg-brand-primary text-white">
          <div className="mx-auto max-w-3xl px-4 py-16 text-center sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-12 2xl:px-16">
            <h2 className="text-4xl tracking-tight text-white sm:text-5xl lg:text-6xl">
              Need Backflow
              <br className="hidden sm:block" /> Prevention Service
              <br className="hidden sm:block" /> in Las Vegas?
            </h2>
