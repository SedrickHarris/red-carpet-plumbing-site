...
const LAS_VEGAS_EMERGENCY_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes. Slab leaks are a common plumbing emergency in Las Vegas due to the area's concrete slab construction. Red Carpet Plumbing provides slab leak detection and repair service throughout Las Vegas and the Las Vegas Valley.",
  },
  {
    question:
  ...
  return (
    <>
      ...
      <main id="main" className="flex-1 bg-white">
        ...
        <CTASection
          background="red"
          headline="Need an Emergency Plumber in Las Vegas?"
          body="Do not wait on a plumbing emergency. Call Red Carpet Plumbing at (702) 567-9172 or request service online. We serve homes and businesses throughout Las Vegas and the Las Vegas Valley."
          primaryCTA={{
            label: "Call (702) 567-9172",
            href: "tel:+17025679172",
          }}
