  ...
  return (
    <>
      ...
      <main id="main" className="flex-1 bg-white">
        ...
        <CTASection
          background="red"
          headline={<>Water Heater Problems<br />in Las Vegas?</>}
          body="Do not wait on a failing water heater. Call Red Carpet Plumbing at (702) 567-9172 or request service online. We repair and install water heaters throughout the Las Vegas Valley, with all work completed to current Clark County plumbing code."
          primaryCTA={{
            label: "Call (702) 567-9172",
            href: "tel:+17025679172",
          }}
