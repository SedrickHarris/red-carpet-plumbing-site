  ...
  return (
    <>
      ...
      <main id="main" className="flex-1 bg-white">
        ...
        <section
          aria-label="Why Las Vegas customers choose Red Carpet Plumbing for toilet repair"
        ...
        >
          <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-10 xl:px-12">
            <ul className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2 lg:grid-cols-4">
              {LV_TOILET_TRUST_STRIP.map((item) => (
          ...
          <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24">
            ...
            <div className="mt-8 rounded-2xl border-l-4 border-brand-primary bg-brand-surface-alt p-6 sm:p-8">
              <p className="text-lg leading-8 text-brand-dark/80">
                ...
                homes and businesses throughout Las Vegas and the Las Vegas Valley.
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-white/80">
                  ...
                  wax ring replacement, and full toilet replacement throughout Las
                  Vegas and the Las Vegas Valley. NV Contractor License #0048585A.
                </p>
        ...
        <CTASection
          background="red"
          headline="Need Toilet Repair or Installation in Las Vegas?"
          body="Red Carpet Plumbing provides toilet repair, replacement, and installation throughout Las Vegas and the Las Vegas Valley. Licensed, local, transparent pricing. NV #0048585A."
          primaryCTA={{
            label: "Call (702) 567-9172",
            href: "tel:+17025679172",
          }}
