...
const serviceSchema = {
  ...
  description:
    "Red Carpet Plumbing provides sewer line inspection, cleaning, repair, and replacement for homes and businesses throughout Las Vegas and the Las Vegas Valley, including trenchless CIPP pipe lining, pipe bursting, root intrusion removal, and emergency sewer line service.",
  provider: {
    "@type": "Plumber",
  ...
  return (
    <>
      ...
      <main id="main" className="flex-1 bg-white">
        ...
        <section
          aria-label="Why Las Vegas customers choose Red Carpet Plumbing for sewer line service"
              ...
              <SectionRevealItem>
                <div className="max-w-3xl text-left">
                  ...
                  <p className="mt-6 text-lg leading-8 text-brand-dark/80">
                    ...
                    throughout Las Vegas and the Las Vegas Valley. We diagnose
                    before we recommend.
                  </p>
                </div>
              </SectionRevealItem>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-white/80">
                  ...
                  repair, and replacement throughout Las Vegas and the Las
                  Vegas Valley. We start with a camera inspection so you know
        ...
        <section className="bg-brand-primary text-white">
          <div className="mx-auto max-w-3xl px-4 py-16 text-center sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-12 2xl:px-16">
            ...
            <p className="mt-6 text-lg leading-8 text-white/80 sm:text-xl">
              ...
              cleaning, repair, and replacement throughout Las Vegas and the
              Las Vegas Valley. Licensed plumbers, 4.8-star rated, NV
              #0048585A.
            </p>
            <div className="mt-10">
