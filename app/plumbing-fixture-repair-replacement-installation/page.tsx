...
const webpageSchema = {
  ...
  description:
    "Red Carpet Plumbing repairs, replaces, and installs plumbing fixtures throughout Las Vegas and the Las Vegas Valley. NV Licensed #0048585A. Call (702) 567-9172.",
    ...
    <>
      ...
      <main id="main" className="flex-1 bg-white">
        ...
        <HeroSection
          ...
          subheading="Repair, replacement, and installation of plumbing fixtures for kitchens, bathrooms, and utility areas throughout Las Vegas and the Las Vegas Valley."
          trustItems={[
            "Licensed Plumbers, NV #0048585A",
            "4.8 Stars, 76 Google Reviews",
            "Residential and Commercial Service",
        ...
        <section
          aria-label="Why Las Vegas customers choose Red Carpet Plumbing for fixture work"
