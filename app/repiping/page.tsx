...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://redcarpetplumbing.com/repiping/",
  },
  openGraph: {
    title: "Repiping Services in Las Vegas, NV | Red Carpet Plumbing",
    description:
...
const REPIPING_SERVICES: ServiceTypeCard[] = [
  ...
  },
  {
    ...
    href: "/repiping/polybutylene-replacement/",
  },
  {
    ...
    href: "/repiping/kitec-replacement/",
  },
  {
    ...
    href: "/repiping/galvanized-replacement/",
  },
  {
    title: "PEX Repiping",
    description:
...
const SERVICE_AREA_LINKS: { name: string; href?: string }[] = [
  { name: "Las Vegas", href: "/las-vegas/repiping/" },
  { name: "Henderson", href: "/henderson/repiping/" },
  { name: "North Las Vegas" },
  { name: "Aliante Area" },
  { name: "Summerlin", href: "/summerlin/repiping/" },
  { name: "Paradise" },
  { name: "Spring Valley", href: "/spring-valley/repiping/" },
  { name: "Enterprise", href: "/enterprise/repiping/" },
  { name: "Boulder City" },
  { name: "Green Valley", href: "/green-valley/repiping/" },
  { name: "Lake Las Vegas" },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: "Repiping",
      item: "https://redcarpetplumbing.com/repiping/",
    },
  ],
};
