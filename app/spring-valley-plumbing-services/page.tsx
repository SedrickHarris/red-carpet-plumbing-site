...
const SPRING_VALLEY_FAQS: FaqItem[] = [
  ...
  {
    question: "Do you offer same-day plumbing service in Spring Valley?",
    answer:
      "Same-day plumbing service is available in Spring Valley, subject to scheduling. Call (702) 567-9172 to check same-day availability for your address.",
    category: "timing-process",
  },
];
