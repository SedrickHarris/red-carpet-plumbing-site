...
const HENDERSON_REPIPE_FAQS = [
  ...
  {
    question: "Do you offer same-day repiping service in Henderson?",
    answer:
      "Same-day repiping service is available in Henderson, subject to scheduling. Call (702) 567-9172 to check same-day availability for your address.",
  },
];
...
const REPIPE_SERVICES = [
  {
    ...
    imageAlt: "Red Carpet Plumbing whole-house repiping in Henderson, NV",
  },
  {
    ...
    imageAlt: "Red Carpet Plumbing partial repiping in Henderson, NV",
  },
  {
    ...
    imageAlt: "Red Carpet Plumbing polybutylene pipe replacement in Henderson, NV",
  },
  {
    ...
    imageAlt: "Red Carpet Plumbing Kitec pipe replacement in Henderson, NV",
  },
  {
    ...
    imageAlt: "Red Carpet Plumbing galvanized steel pipe replacement in Henderson, NV",
  },
  {
    title: "PEX Repiping",
    description:
    ...
    imageAlt: "Red Carpet Plumbing PEX repiping in Henderson, NV",
  },
  {
    ...
    imageAlt: "Red Carpet Plumbing copper repiping in Henderson, NV",
  },
];
...
const serviceSchema = {
  ...
  description:
    "Professional repiping services in Henderson, NV. Red Carpet Plumbing provides whole-house and partial repiping, polybutylene replacement, Kitec replacement, galvanized replacement, and PEX or copper installation throughout Henderson.",
  provider: {
    "@type": "Plumber",
    name: "Red Carpet Plumbing",
    url: "https://redcarpetplumbing.com",
  ...
  return (
    <>
      ...
      <main id="main" className="flex-1 bg-white">
          ...
          <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24">
            <div className="text-left">
              <h2 className="text-3xl tracking-tight text-brand-dark sm:text-4xl lg:text-5xl">
                ...
                <br className="hidden sm:block" /> About Repiping in Henderson
              </h2>
            </div>
        ...
        <CTASection
          background="red"
          headline={<>Repiping Services<br />Throughout Henderson, NV</>}
