...
// used an em dash ("What is Paradise, NV — is it part of Las Vegas?"), which the
// project copy rules prohibit. Reworded to an em-dash-free phrasing; meaning
// preserved and visible text + schema remain identical (both map from here).
// ---------------------------------------------------------------------------
const PARADISE_FAQS = [
  {
    question: "Does Red Carpet Plumbing serve Paradise, NV?",
    answer:
      "Yes. Red Carpet Plumbing provides plumbing services throughout Paradise, Nevada, including residential neighborhoods and commercial properties near the Las Vegas Strip corridor. Call (702) 567-9172 to confirm coverage for your address.",
  },
  {
    question: "What is Paradise, NV, and is it part of Las Vegas?",
    answer:
      "Paradise is an unincorporated community in Clark County, Nevada. It is geographically adjacent to the City of Las Vegas but is a separate jurisdiction. The Las Vegas Strip and many surrounding neighborhoods and businesses have Paradise, NV addresses. Red Carpet Plumbing serves both the City of Las Vegas and Paradise.",
  },
  {
    question:
  ...
  {
    question:
      "What plumbing services does Red Carpet Plumbing offer in Paradise, NV?",
    answer:
      "Red Carpet Plumbing provides a full range of residential and commercial plumbing services in Paradise including emergency plumbing, drain cleaning, water heater repair and installation, leak detection, gas line plumbing, commercial plumbing, backflow prevention, and more.",
  },
  {
  ...
  {
    question: "How do I request plumbing service in Paradise, NV?",
    answer:
      "Call Red Carpet Plumbing at (702) 567-9172 or submit a service request online. For emergency plumbing in Paradise, calling directly is the fastest option.",
  },
];
...
// TODO-BATCH-PHASE4: /paradise/[service]/ service-location pages not yet built.
...
const PARADISE_SERVICES: ServiceLink[] = [
  {
    title: "Emergency Plumbing",
    href: "/emergency-plumbing/",
    image: "/images/services/emergency-plumbing/card.webp",
    imageAlt: "24/7 emergency plumbing service in Paradise, NV",
  },
  {
    title: "Drain Cleaning",
    href: "/drain-cleaning/",
    image: "/images/services/drain-cleaning/card.webp",
    imageAlt: "Drain cleaning service in Paradise, NV",
  },
  {
    title: "Leak Detection and Repair",
    href: "/leak-detection-repair/",
    image: "/images/services/leak-detection-repair/card.webp",
    imageAlt: "Leak detection and repair in Paradise, NV",
  },
  {
  ...
  },
  {
    ...
    imageAlt: "Slab leak detection and repair in Paradise, NV",
  },
  {
  ...
  },
  {
    ...
    imageAlt: "Water pipe repair and replacement in Paradise, NV",
  },
  {
    title: "Gas Line Plumbing",
    href: "/gas-line-plumbing/",
    imageAlt: "Gas line plumbing service in Paradise, NV",
  },
  {
    title: "Commercial Plumbing",
    href: "/commercial-plumbing/",
    imageAlt: "Commercial plumbing services in Paradise, NV",
  },
  {
    title: "Toilet Repair and Installation",
    href: "/toilet-repair-installation/",
    imageAlt: "Toilet repair and installation in Paradise, NV",
  },
  {
    title: "Faucet and Sink Repair and Installation",
    href: "/faucet-sink-repair-installation/",
    imageAlt: "Faucet and sink repair and installation in Paradise, NV",
  },
  {
    title: "Garbage Disposal Repair and Installation",
    href: "/garbage-disposal-repair-installation/",
    imageAlt: "Garbage disposal repair and installation in Paradise, NV",
  },
  {
    title: "Backflow Prevention",
    href: "/backflow-prevention/",
    imageAlt: "Backflow prevention services in Paradise, NV",
  },
  {
    title: "Video Camera Plumbing Inspections",
    href: "/video-camera-plumbing-inspections/",
    imageAlt: "Video camera plumbing inspections in Paradise, NV",
  },
  {
    title: "Plumbing Fixture Repair, Replacement and Installation",
    href: "/plumbing-fixture-repair-replacement-installation/",
    imageAlt:
      "Plumbing fixture repair replacement and installation in Paradise, NV",
  },
  {
    title: "Trenchless Piping",
    href: "/trenchless-piping/",
    imageAlt: "Trenchless piping services in Paradise, NV",
  },
  {
    title: "Water Meter and Pressure Regulator Services",
    href: "/water-meter-pressure-regulator-services/",
    imageAlt: "Water meter and pressure regulator services in Paradise, NV",
  },
];

// Plain-text area signals. Routes are not yet built, so these render as text.
// TODO-BATCH-TIER3: /paradise/south-strip-plumbing/ and
// /paradise/airport-corridor-plumbing/ are future Tier 3 pages. Do not render
// as links. Plain text mention only.
const PARADISE_AREAS = [
  "Strip Corridor",
...
const PARADISE_CONTEXT = [
  ...
  },
  {
    ...
    body: "Beyond the Strip corridor, Paradise includes substantial residential areas: neighborhoods surrounding the UNLV campus, mid-century residential areas between the Strip and Eastern Avenue, and the residential corridors along Tropicana and Flamingo. Many homes in these areas were built in the 1960s through 1980s and share the same plumbing challenges common in older Las Vegas Valley housing, including aging galvanized or copper supply lines, original fixtures, and slab foundations subject to hard water and caliche soil stress. Residential plumbing service in Paradise covers the same range of issues Red Carpet Plumbing handles throughout the Las Vegas Valley.",
  },
];
...
// JSON-LD payloads
// ---------------------------------------------------------------------------
// Paradise is an unincorporated community, not an incorporated city, so
// areaServed uses Place + containedInPlace (Clark County) rather than City with
// a sameAs Wikidata link that could misrepresent its legal status.
const plumberSchema = {
...
const faqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: PARADISE_FAQS.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
  ...
  return (
    <>
      ...
      <main id="main" className="flex-1 bg-white">
          ...
          <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24">
            <div className="rounded-2xl border-l-4 border-brand-primary bg-brand-surface-alt p-6 sm:p-8">
              <h2 className="text-2xl font-bold tracking-tight text-brand-dark sm:text-3xl">
                Licensed Plumbing Services in Paradise, Nevada
              </h2>
              <p className="mt-4 text-lg leading-8 text-brand-dark/80">
                Red Carpet Plumbing is a local, family-owned plumbing company
                serving Paradise, Nevada and the surrounding Las Vegas Valley.
        ...
        {/* SECTION 3: PARADISE PLUMBING CONTEXT */}
        <section className="bg-white">
              ...
              <SectionRevealItem>
                <div className="text-left">
                  ...
                  <p className="mt-6 text-lg leading-8 text-brand-dark/80">
                    Paradise pairs the densest commercial plumbing demand in the
                    Las Vegas Valley with established residential neighborhoods.
                    Here is what sets plumbing in Paradise apart and how Red
                    Carpet Plumbing serves the area.
                  </p>
                </div>
              </SectionRevealItem>

              <SectionRevealItem className="mt-12 space-y-10">
                {PARADISE_CONTEXT.map((item) => (
                  <article
                    key={item.title}
            ...
            <SectionReveal>
              <SectionRevealItem>
                <div className="max-w-3xl text-left">
                  <h2 className="text-3xl font-bold tracking-tight text-brand-dark sm:text-4xl lg:text-5xl">
                    Plumbing Services We Provide in Paradise
                  </h2>
                  <p className="mt-6 text-lg leading-8 text-brand-dark/80">
                    Red Carpet Plumbing provides a full range of residential and
                    commercial plumbing services for Paradise homes and
                    businesses.
                  </p>
                </div>
              </SectionRevealItem>
        ...
        {/* SECTION 5: PARADISE AREAS */}
        <section className="bg-brand-charcoal text-white">
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-12">
            <div className="max-w-3xl text-left">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
                Paradise Neighborhoods and Corridors We Serve
              </h2>
              <p className="mt-6 text-lg leading-8 text-white/85">
                Red Carpet Plumbing serves homes and businesses throughout
                Paradise. If your neighborhood or corridor is not listed, call
                (702) 567-9172 to confirm coverage.
              </p>
            </div>

            {/* TODO-BATCH-TIER3: /paradise/south-strip-plumbing/ and */}
            {/* /paradise/airport-corridor-plumbing/ are future Tier 3 pages. */}
            {/* Do not render as links. Plain text mention only. */}
            <ul className="mt-12 flex flex-wrap gap-3">
              {PARADISE_AREAS.map((name) => (
                <li key={name}>
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-white/90">
                  ...
                  for Paradise homes and businesses. Burst pipes, sewer backups,
                  water heater failures, gas line concerns, and major leaks are
          ...
          <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24">
            <div className="text-left">
              <h2 className="text-3xl font-bold tracking-tight text-brand-dark sm:text-4xl lg:text-5xl">
                ...
                <br className="hidden sm:block" /> About Plumbing in Paradise, NV
              </h2>
            </div>
            <div className="mt-12 space-y-4">
              {PARADISE_FAQS.map((faq) => (
                <details
                  key={faq.question}
        ...
        <CTASection
          background="red"
          headline={<>Request Plumbing Service<br />in Paradise, NV</>}
