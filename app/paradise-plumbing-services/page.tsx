...
const PARADISE_FAQS: FaqItem[] = [
  ...
  {
    question: "Do you offer same-day plumbing service in Paradise?",
    answer:
      "Same-day plumbing service is available in Paradise, subject to scheduling. Call (702) 567-9172 to check same-day availability for your address.",
    category: "timing-process",
  },
];
...
const PARADISE_PILLS_ROW_TWO: ServicePill[] = [
  {
            ...
            <SectionReveal>
              ...
              <SectionRevealItem className="mt-14">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                  {PARADISE_FEATURED_SERVICES.map((service) => (
                    <ServiceCard
                      key={service.href}
                      title={service.title}
                      description=""
              ...
              <SectionRevealItem className="mt-10">
                ...
                <div className="flex flex-col gap-4">
                  <PillRow pills={PARADISE_PILLS_ROW_ONE} variant="outline" />
                  <PillRow pills={PARADISE_PILLS_ROW_TWO} variant="solid" />
                </div>
              </SectionRevealItem>
            </SectionReveal>
          </div>
