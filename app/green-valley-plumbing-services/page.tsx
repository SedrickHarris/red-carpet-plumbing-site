...
const GREEN_VALLEY_FAQS: FaqItem[] = [
  ...
  {
    question: "Do you offer same-day plumbing service in Green Valley?",
    answer:
      "Same-day plumbing service is available in Green Valley, subject to scheduling. Call (702) 567-9172 to check same-day availability for your address.",
    category: "timing-process",
  },
];
