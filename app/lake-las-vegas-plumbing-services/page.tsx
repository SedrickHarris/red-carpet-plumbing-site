...
const LAKE_LAS_VEGAS_FAQS: FaqItem[] = [
  ...
  {
    question: "Do you offer same-day plumbing service in Lake Las Vegas?",
    answer:
      "Same-day plumbing service is available in Lake Las Vegas, subject to scheduling. Call (702) 567-9172 to check same-day availability for your address.",
    category: "timing-process",
  },
];
...
const LAKE_LAS_VEGAS_FEATURED_SERVICES: ServiceLink[] = [
  {
...
const LAKE_LAS_VEGAS_PILLS_ROW_ONE: ServicePill[] = [
  {
...
const LAKE_LAS_VEGAS_PILLS_ROW_TWO: ServicePill[] = [
  {
  ...
  return (
    <>
      ...
      <main id="main" className="flex-1 bg-white">
            ...
            <SectionReveal>
              ...
              <SectionRevealItem className="mt-14">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                  {LAKE_LAS_VEGAS_FEATURED_SERVICES.map((service) => (
                    <ServiceCard
                      key={service.href}
                      title={service.title}
                      description=""
              ...
              <SectionRevealItem className="mt-10">
                ...
                <div className="flex flex-col gap-4">
                  <PillRow pills={LAKE_LAS_VEGAS_PILLS_ROW_ONE} variant="outline" />
                  <PillRow pills={LAKE_LAS_VEGAS_PILLS_ROW_TWO} variant="solid" />
                </div>
              </SectionRevealItem>
            </SectionReveal>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-12">
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              ...
              <div className="flex flex-col items-start gap-4 lg:items-end">
                ...
                <Button href="/lake-las-vegas/emergency-plumbing/" variant="inverse-outline" size="lg">
        ...
        <CTASection
          background="red"
          headline={<>Request Plumbing Service<br />in Lake Las Vegas</>}
