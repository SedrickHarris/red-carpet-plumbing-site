...
const LAS_VEGAS_FAQS: FaqItem[] = [
  ...
  {
    question: "Do you offer same-day plumbing service in Las Vegas?",
    answer:
      "Same-day plumbing service is available in Las Vegas, subject to scheduling. Call (702) 567-9172 to check same-day availability for your address.",
    category: "timing-process",
  },
];
            ...
            <SectionReveal>
              ...
              <SectionRevealItem className="mt-14">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                  {LAS_VEGAS_FEATURED_SERVICES.map((service) => (
                    <ServiceCard
                      key={service.href}
                      title={service.title}
                      description=""
              ...
              <SectionRevealItem className="mt-10">
                ...
                <div className="flex flex-col gap-4">
                  <PillRow pills={LAS_VEGAS_PILLS_ROW_ONE} variant="outline" />
                  <PillRow pills={LAS_VEGAS_PILLS_ROW_TWO} variant="solid" />
                </div>
              </SectionRevealItem>
            </SectionReveal>
          </div>
