...
const SERVICE_AREA_LINKS: { name: string; href?: string }[] = [
  { name: "Las Vegas", href: "/las-vegas/leak-detection-repair/" },
  { name: "Henderson", href: "/henderson/leak-detection-repair/" },
  { name: "North Las Vegas", href: "/north-las-vegas/leak-detection-repair/" },
  { name: "Aliante Area", href: "/north-las-vegas/aliante-area/leak-detection-repair/" },
  { name: "Summerlin", href: "/summerlin/leak-detection-repair/" },
  { name: "Paradise", href: "/paradise/leak-detection-repair/" },
  { name: "Spring Valley", href: "/spring-valley/leak-detection-repair/" },
  { name: "Enterprise", href: "/enterprise/leak-detection-repair/" },
  { name: "Boulder City", href: "/boulder-city/leak-detection-repair/" },
  { name: "Green Valley", href: "/green-valley/leak-detection-repair/" },
  { name: "Lake Las Vegas", href: "/lake-las-vegas/leak-detection-repair/" },
];
