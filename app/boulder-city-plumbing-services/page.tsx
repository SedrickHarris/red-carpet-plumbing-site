...
export const metadata: Metadata = {
  ...
  description:
    "Licensed plumbing in Boulder City, NV for historic and newer homes. Emergency plumbing, drain cleaning, water heater repair, re-piping. NV #0048585A. Call (702) 567-9172.",
  alternates: {
