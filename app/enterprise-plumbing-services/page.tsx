...
export const metadata: Metadata = {
  ...
  description:
    "Licensed residential and commercial plumbing in Enterprise, NV and Southwest Las Vegas. Emergency plumbing, drain cleaning, water heater repair. NV #0048585A. Call (702) 567-9172.",
  alternates: {
