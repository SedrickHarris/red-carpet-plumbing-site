...
const ENTERPRISE_FAQS: FaqItem[] = [
  ...
  {
    question: "Do you offer same-day plumbing service in Enterprise?",
    answer:
      "Same-day plumbing service is available in Enterprise, subject to scheduling. Call (702) 567-9172 to check same-day availability for your address.",
    category: "timing-process",
  },
];
  ...
  return (
    <>
      ...
      <main id="main" className="flex-1 bg-white">
            ...
            <SectionReveal>
              ...
              <SectionRevealItem className="mt-10">
                ...
                <div className="flex flex-col gap-4">
                  <PillRow pills={ENTERPRISE_PILLS_ROW_ONE} variant="outline" />
                  <PillRow pills={ENTERPRISE_PILLS_ROW_TWO} variant="solid" />
                </div>
              </SectionRevealItem>
            </SectionReveal>
          </div>
        ...
        <CTASection
          background="red"
          headline={<>Request Plumbing Service<br />in Enterprise</>}
